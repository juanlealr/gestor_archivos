...
* *Nota: Durante la instalación de Visual Studio, asegúrate de marcar la carga de trabajo **"Desarrollo de escritorio de .NET"**.*
...
3. Haz clic derecho sobre el proyecto **`FileManager.UI`** en el Explorador de soluciones y selecciona **"Establecer como proyecto de inicio"** (*Set as StartUp Project*).
...
dotnet run --project src/FileManager.UI/FileManager.UI.csproj
...
* *Doble clic:* Abre carpetas para navegar o ejecuta archivos con la aplicación nativa de Windows.
* *Clic derecho:* Despliega el menú contextual con operaciones rápidas (Copiar, Mover, Cambiar nombre, Eliminar y Propiedades).
